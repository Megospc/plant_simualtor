...
const options_list = [ //Список настроек
  ...
  { id: "fairred", type: "num", default: 0, check: [0, 1000, false], label: "Пожар — углекислый газ: ", f: x => x, g: x => x },
  { id: "fairgreen", type: "num", default: 0, check: [0, 1000, false], label: "Пожар — метан: ", f: x => x, g: x => x },
  { id: "fairblue", type: "num", default: 0, check: [0, 1000, false], label: "Пожар — кислород: ", f: x => x, g: x => x },
